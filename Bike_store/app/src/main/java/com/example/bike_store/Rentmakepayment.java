...
public class Rentmakepayment extends AppCompatActivity implements JsonResponse {
    EditText e1,e2,e3;
    Button b1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rentmakepayment);
        ...
        e3.setText(Viewothervehicle.amt);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else if(cvv.equalsIgnoreCase("")|| cvv.length()!=3)
                {
                    ...
                    JR.json_response = (JsonResponse) Rentmakepayment.this;
                    String q = "/Rentmakepayment?log_id=" + sh.getString("log_id", "")+ "&amount=" + Viewothervehicle.amt +"&rid=" +Viewmyrendrequest.reqid;
                    q = q.replace(" ", "%20");
                    JR.execute(q);
                }
