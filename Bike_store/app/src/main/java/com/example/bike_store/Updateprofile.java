...
public class Updateprofile extends AppCompatActivity implements JsonResponse {
    ...
    Button b1;
    String name,lname,place,phone,email,uname,pwd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                pwd=e7.getText().toString();


                JsonReq JR=new JsonReq();
                JR.json_response=(JsonResponse) Updateprofile.this;
                String q = "/Userprofile?login_id="+sh.getString("log_id", "")+"&name="+name+"&place="+place+"&Phone="+phone+ "&email="+email +"&lname="+lname+ "&uname="+uname +"&pwd="+pwd;
                q=q.replace(" ","%20");
                JR.execute(q);
            }
        });
        ...
        try {
            ...
            if(method.equalsIgnoreCase("ViewUserprofile")) {
                ...
                if (status.equalsIgnoreCase("success")) {
                    ...
                    e6.setText(ja1.getJSONObject(0).getString("username"));
                    e7.setText(ja1.getJSONObject(0).getString("password"));
