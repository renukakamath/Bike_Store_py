...
public class Rateing extends AppCompatActivity implements JsonResponse{
    RatingBar ratingbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        B1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                JR.json_response = (JsonResponse) Rateing.this;
                String q = "/rateing?rating=" + rat + "&log_id=" + sh.getString("log_id", "")+"&review="+rev +"&bid="+Userviewbike.bid ;
                q = q.replace(" ", "%20");
                JR.execute(q);
            }
        });
