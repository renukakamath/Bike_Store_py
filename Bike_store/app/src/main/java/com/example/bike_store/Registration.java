...
public class Registration extends AppCompatActivity implements JsonResponse {
    ...
    Button b1;
    String fname,lname,city,hname,street,username,password,confirmPassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        e7=(EditText) findViewById(R.id.passwordEditText);
        e8=(EditText)findViewById(R.id.confirmPasswordEditText) ;
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                confirmPassword=e8.getText().toString();
                ...
                else if(hname.equalsIgnoreCase("")|| hname.length()!=10)
                {
                    e4.setError("Enter your phone");
                    e4.setFocusable(true);
                }
                else if(street.equalsIgnoreCase("")|| !street.matches("[a-zA-Z0-9._-]+@[a-z]+\\.[a-z]+"))
                {
                ...
                if (password.isEmpty()) {
                    ...
                    e8.setError("Confirm your password");
                    e8.requestFocus();
                } else if (!password.equals(confirmPassword)) {
                    e8.setError("Passwords do not match");
                    e8.requestFocus();
                }
