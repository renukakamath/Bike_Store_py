...
public class Cartpayment extends AppCompatActivity implements JsonResponse {
    EditText e1,e2,e3;
    Button b1;
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else if(cvv.equalsIgnoreCase("")|| cvv.length()!=3)
                {
                    ...
                    JR.json_response = (JsonResponse) Cartpayment.this;
                    String q = "/Cartpayment?log_id=" + sh.getString("log_id", "")+ "&amount=" + Viewcart.amt +"&omid="+Viewcart.omid  ;
                    q = q.replace(" ", "%20");
                    JR.execute(q);
                }
