...
public class Custimage3 extends ArrayAdapter<String>  {
	...
	private String[] image;
	 ...
	 public Custimage3(Activity context, String[] img   ) {
	        //constructor of this class to get the values from main_activity_class

	        super(context, R.layout.cust_images3, img);
	    ...
	    public View getView(int position, View convertView, ViewGroup parent) {
	        ...
	        View listViewItem = inflater.inflate(R.layout.cust_images3, null, true);
